...
public class CharityArea extends AbstractController {
    private static final String TAG = "CharityArea=> ";
    private static CharityArea instance;
    ...
    public static CharityArea getInstance() {
        if (instance == null) {
            try {
                instance = new CharityArea();
            } catch (Exception e) {
...
//            Utils.restroreInstanceView(instance.getClass().getSimpleName(), Account.loggedIn ? Lang.get("charity") : Title);
        }
...
//        loginController = "AccountArea";
        loginController = "CharityArea";
        /* set content title */
        Config.context.setTitle(Account.loggedIn ? Lang.get("my_profile") : Title);
//        Config.context.setTitle(Account.loggedIn ? Lang.get("charity") : Title);
        ...
        /* start pager */
        String[][] tabs = {
                {"Creat Charity", "Create Charity"},
                {"Donate Charity", "Donate charity"}
        };
    ...
    public static void logout() {
        DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                Log.e(TAG, "onclick logut=> " + Account.accountData.get("id"));
    ...
    public final static class ProfileFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            View layout = null;
            if (tabKey.equals("Creat Charity")) {
                layout = createPrifileTab();
                Log.e(TAG, "Creat Charitylayout" + tabKey);
            } else if (tabKey.equals("Donate Charity")) {
                layout = createPasswordTab();
                Log.e(TAG, "Donate Charity" + tabKey);
            }
...
//        profileTab = (LinearLayout) Config.context.getLayoutInflater().inflate(R.layout.profile_tab, null);
        profileTab = (LinearLayout) Config.context.getLayoutInflater().inflate(R.layout.creat_charity_tab, null);

        profileTab.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
    ...
    private static LinearLayout createPasswordTab() {
        passwordTab = (LinearLayout) Config.context.getLayoutInflater().inflate(R.layout.donate_charity_tab, null);

        passwordTab.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
