...
//				}
        ...
        /*Implements Static menu for charity &food crate and donate at 31.july2019*/
        ///
        ...
        if (Config.cacheAccountTypes.size() > 0) {
            ...
            map0.put("type", "controller");
            map0.put("account", null);
            map0.put("name", "Charity");
            map0.put("icon", "divider");
            map0.put("controller", null);
            map0.put("count", null);
            menuData.add(map0);
            for (int v = 0; v < 2; v++) {
                if (v == 0) {
                    HashMap<String, String> map1 = new HashMap<String, String>();
                    map1.put("type", "controller");
                    map1.put("account", null);
                    map1.put("name", "Charity Create");
                    map1.put("icon", "newItem");
                    map1.put("controller", "CharityActivity");
                    map1.put("count", null);
                    menuData.add(map1);
                    HashMap<String, String> map2 = new HashMap<String, String>();
                    map2.put("type", "controller");
                    map2.put("account", null);
                    map2.put("name", "Food Create");
                    map2.put("icon", "newItem");
                    map2.put("controller", "CharityActivity");
                    map2.put("count", null);
                    menuData.add(menuData.size(), map2);
                }
